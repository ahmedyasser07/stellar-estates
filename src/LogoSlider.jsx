...
const LogosSlider = () => {
    ...
    return (
        <div class="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
            <ul class="flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none" onMouseEnter={() => setState('paused')} onMouseLeave={() => setState('running')} style={{animation: '20s slide infinite linear',animationPlayState:state}}>
                {
                    [...logos_1, ...logos_2].map(logo => (

                        <li>
                            <img className=" h-16  md:h-[100px]" src={`./logos/${logo}`} alt="Your Image" />
                        </li>
